...
As advertised earlier, our half-day tutorial "Tools to Detect and Diagnose Floating-Point Errors in Heterogeneous Computing Hardware and Software (tut122)" covers three tools: FPChecker, GPU-FPX and FloatGuard (video overview at [https://lnkd.in/g6tU8FEV](https://lnkd.in/g6tU8FEV)).

The first part of the tutorial, FPChecker, is about LLVM-based Floating-Point Exception Tracing. Those who want to follow along the FPChecker exercises on Mac OS or Linux may kindly install the Conda environment (instructions for Mac are provided at [https://youtu.be/DNu8pQOYRGg](https://youtu.be/DNu8pQOYRGg).
